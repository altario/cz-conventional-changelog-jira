...
| CZ_JIRA_EMOJI_TYPES       | jiraEmojiTypes      | false             | If this is set to true, commit types have emoji (ex: 🐛) for best visibility.                                                                                           |
...
| CZ_JIRA_PREPEND           | jiraPrepend         | ""                | Prepends JIRA ID with an optional decorator. e.g.: `[ALT-1234`.                                                                                                         |
| CZ_JIRA_APPEND            | jiraAppend          | ""                | Appends JIRA ID with an optional decorator. e.g.: `ALT-1234]`.                                                                                                          |
...
| jiraPrepend     | ""                | Prepends JIRA ID with an optional decorator. e.g.: `[ALT-1234`                                                                                                                                                                               |
| jiraAppend      | ""                | Appends JIRA ID with an optional decorator. e.g.: `ALT-1234]`                                                                                                                                                                                |
